...
class BannerView: UIView
{
    ...
    func createBanner(imagesArray:[UIImage], widthScreen:CGFloat)
    {
        ...
        self.createImageList(array: imagesArray)
      
        timer = Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(BannerView.actionAutoSlide), userInfo: nil, repeats: true)
    }
